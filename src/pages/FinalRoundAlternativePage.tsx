...
const faqs = [
  {
    q: "Is Smeed AI cheaper than Final Round AI?",
    a: "Yes. Smeed AI is significantly more affordable while still covering key interview prep and real-time assistance features.",
  },
  {
    q: "Can Smeed AI replace expensive interview assistant subscriptions?",
    a: "For most candidates, yes. Smeed AI focuses on core outcomes with strong feature coverage and better pricing.",
  },
  {
    q: "Does Smeed AI support both behavioral and technical interview prep?",
    a: "Yes. It is designed to help with both question types and practical response framing.",
  },
  {
    q: "Who should choose Smeed AI over Final Round AI?",
      ...
      <section className="py-10">
        <div className="saas-container max-w-5xl">
          ...
          <div className="mt-4 rounded-2xl border border-indigo-200 bg-indigo-50 px-4 py-3 text-sm text-indigo-700">
            🏆 Smeed AI is a cost-effective and practical alternative for interview preparation.
          </div>
          ...
          <p className="mt-3 text-gray-600 max-w-3xl">
            Compare Smeed AI and Final Round AI side by side across pricing,
        ...
        <div className="saas-container max-w-5xl">
          <div className="saas-card overflow-x-auto">
            <h2 className="text-xl font-semibold">
              Final Round AI vs Smeed AI: Detailed Comparison
            </h2>
        ...
        <div className="saas-container max-w-5xl">
          <div className="saas-card">
            <h2 className="text-2xl font-bold">
              Why is Smeed AI more affordable than Final Round AI?
            </h2>
      ...
      <section className="pb-8">
        <div className="saas-container max-w-5xl">
          <div className="saas-card bg-gradient-to-r from-rose-50 to-emerald-50">
            <h2 className="text-2xl font-bold">Key Differences: Final Round AI vs Smeed AI</h2>
          ...
          <div className="mt-4 grid md:grid-cols-2 gap-4">
            <div className="saas-card">
              ...
              <p className="mt-2 text-sm text-gray-700">
                “I got similar support quality but saved a lot monthly after switching to Smeed AI.”
              </p>
            ...
            <div className="saas-card">
              <p className="text-amber-500">★★★★★</p>
              <p className="mt-2 text-sm text-gray-700">
                “Smeed AI gave me practical interview support without heavy subscription pressure.”
              </p>
        ...
        <div className="saas-container max-w-5xl">
          ...
          <div className="mt-4 grid md:grid-cols-3 gap-4">
            {[
              ...
              { title: "Smeed AI vs Interview Warmup", href: "/affordable-interview-assistants" },
            ].map((item) => (
        ...
        <div className="saas-container max-w-5xl">
          <div className="rounded-2xl border border-amber-200 bg-amber-50 p-8 text-center">
            ...
            <p className="mt-3 text-gray-600">
              Start with Smeed AI today and prepare with confidence at a better cost.
            </p>
